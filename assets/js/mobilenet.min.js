            ...
            switch (i.label) {
              case 0:
                return this.modelUrl
                  ? ((e = this), [4, a.loadGraphModel(this.modelUrl)])
                  : [3, 2];
              case 1:
                return (e.model = i.sent()), [3, 4];
              case 2:
                return (
                  (o = l[this.version][this.alpha].url),
                  (t = this),
                  [4, a.loadGraphModel(o, { fromTFHub: !0 })]
                );
              case 3:
      ...
      (e.prototype.infer = function (e, a) {
        ...
        return (
          ...
          r.tidy(function () {
            ...
            var i = e.toFloat().mul(o.normalizationConstant).add(o.inputMin),
              t = i;
            if (224 !== e.shape[0] || 224 !== e.shape[1]) {
              t = r.image.resizeBilinear(i, [224, 224], !0);
            }
            var l,
              s = t.reshape([-1, 224, 224, 3]);
            if (a) {
              var c = n[o.version];
                      ...
                      return o(this, void 0, void 0, function () {
                        ...
                        return i(this, function (i) {
                          switch (i.label) {
                            ...
                            case 1:
                              for (
                                o = i.sent(), r.dispose(), n = [], u = 0;
                                u < o.length;
                                u++
                              )
                                n.push({ value: o[u], index: u });
                              for (
                                n.sort(function (e, a) {
                                ...
                                (l[u] = n[u].value), (s[u] = n[u].index);
                              for (c = [], u = 0; u < s.length; u++)
                                c.push({
                                  className: t[s[u]],
                                  probability: l[u],
                                });
                ...
                if (!(n in l[t]))
                  throw new Error(
                    "MobileNet constructed with invalid alpha " +
                      e.alpha +
                      ". Valid multipliers for this version are: " +
                      Object.keys(l[t]) +
                      "."
                  );
