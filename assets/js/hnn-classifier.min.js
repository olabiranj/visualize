...
!(function (t, a) {
  "object" == typeof exports && "undefined" != typeof module
    ? a(exports, require("@tensorflow/tfjs-core"))
    : "function" == typeof define && define.amd
    ? define(["exports", "@tensorflow/tfjs-core"], a)
    : a((t.knnClassifier = {}), t.tf);
})(this, function (t, a) {
  "use strict";
  function e(t, a) {
    var e,
  ...
  function s(t, a) {
    for (var e = [], s = 0; s < t.length; s++)
      e.push({ value: t[s], index: s });
    e.sort(function (t, a) {
      return a.value - t.value;
    });
    var r = new Float32Array(a),
      n = new Int32Array(a);
    for (s = 0; s < a; s++) (r[s] = e[s].value), (n[s] = e[s].index);
  ...
  var r = (function () {
    ...
    return (
      (t.prototype.addExample = function (t, e) {
        var s = this;
        if (
        ...
        this.clearTrainDatasetMatrix(),
          e in this.labelToClassId ||
            (this.labelToClassId[e] = this.nextClassId++),
          a.tidy(function () {
            var r = s.normalizeVectorToUnitLength(t.flatten()),
              n = r.shape[0];
            if (null == s.classDatasetMatrices[e])
              s.classDatasetMatrices[e] = r.as2D(1, n);
            else {
              var i = s.classDatasetMatrices[e]
                .as2D(s.classExampleCount[e], n)
                .concat(r.as2D(1, n), 0);
              s.classDatasetMatrices[e].dispose(),
                (s.classDatasetMatrices[e] = i);
            }
            a.keep(s.classDatasetMatrices[e]),
              null == s.classExampleCount[e] && (s.classExampleCount[e] = 0),
              s.classExampleCount[e]++;
          });
      }),
      (t.prototype.similarities = function (t) {
        ...
        return a.tidy(function () {
          var s,
            r,
            n = e.normalizeVectorToUnitLength(t.flatten()),
            i = n.shape[0];
          if (null == e.trainDatasetMatrix) {
            var l = null;
            for (var o in e.classDatasetMatrices)
              (s = l),
                (r = e.classDatasetMatrices[o]),
                (l =
                  null == s && null == r
                    ? null
                    : null == s
          ...
          a.keep(e.trainDatasetMatrix);
          var c = e.getNumExamples();
          return e.trainDatasetMatrix.as2D(c, i).matMul(n.as2D(i, 1)).as1D();
        });
      }),
      (t.prototype.predictClass = function (t, r) {
        return (
          ...
          (o = function () {
            ...
            return e(this, function (e) {
              switch (e.label) {
                ...
                case 1:
                  return (
                    (l = o.apply(void 0, [e.sent(), i]).indices),
                    n.dispose(),
          ...
          new ((l = void 0) || (l = Promise))(function (t, a) {
            function e(t) {
              try {
                r(o.next(t));
              } catch (t) {
      ...
      (t.prototype.clearClass = function (t) {
        if (null == this.classDatasetMatrices[t])
          throw new Error("Cannot clear invalid class " + t);
      ...
      (t.prototype.setClassifierDataset = function (t) {
        for (var a in (this.clearTrainDatasetMatrix(),
        (this.classDatasetMatrices = t),
        t))
          this.classExampleCount[a] = t[a].shape[0];
      }),
      (t.prototype.calculateTopClass = function (t, a) {
        ...
        for (var i in this.classDatasetMatrices)
          (n += this.classExampleCount[i]), (r[i] = n);
        var l = {};
        for (var i in this.classDatasetMatrices) l[i] = 0;
        ...
        return { classIndex: this.labelToClassId[e], label: e, confidences: s };
      }),
